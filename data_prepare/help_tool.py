...
#新添加的代码：
BASE_DIR = os.path.dirname(os.path.abspath(__file__))
sys.path.append(os.path.join(BASE_DIR, '../nearest_neighbors/lib/python'))
...
class ConfigSemantic3D:
    ...
    noise_init = 3.5  # noise initial parameter
    max_epoch = 2  # maximum epoch during training
    learning_rate = 1e-2  # initial learning rate
    lr_decays = {i: 0.95 for i in range(0, 500)}  # decay rate of learning rate
...
class DataProcessing:
    ...
    def get_class_weights(dataset_name):
        ...
        if dataset_name == 'S3DIS':
            ...
            num_per_class = np.array([14407793, 0, 2458953, 552323, 1265436, 3072505, 126252],
                                     dtype=np.int32)
